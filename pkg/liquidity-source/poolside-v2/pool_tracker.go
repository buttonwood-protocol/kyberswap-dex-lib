...
func (d *PoolTracker) GetNewPoolState(ctx context.Context, p entity.Pool, _ pool.GetNewPoolStateParams) (entity.Pool, error) {
	...
	extra.RebaseTokenInfoMap = rebaseTokenInfoMap
	...
	return d.updatePool(p, reserveData, blockNumber, extra)
}
...
func (d *PoolTracker) getReservesFromRPCNode(ctx context.Context, poolAddress string) (ReserveData, *big.Int, error) {
	...
	getReservesRequest.AddCall(&ethrpc.Call{
		...
		Params: nil,
	}, []interface{}{&getReservesResult.Pool0, &getReservesResult.Pool1, &getReservesResult.Reservoir0, &getReservesResult.Reservoir1, &getReservesResult.Basin0, &getReservesResult.Basin1, &getReservesResult.BlockTimestampLast})
...
func (d *PoolTracker) updatePool(pool entity.Pool, reserveData ReserveData, blockNumber *big.Int, extra Extra) (entity.Pool, error) {
